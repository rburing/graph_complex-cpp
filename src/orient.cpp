...
int main(int argc, char* argv[])
{
    ...
    for (const GraphSum<ex>::Term& pair: graph_sum)
    {
        ...
        std::vector<int> degrees(graph.vertices(), 2); // TODO: more general. TODO: Leibniz graph encodings.
